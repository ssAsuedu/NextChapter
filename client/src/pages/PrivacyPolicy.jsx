        ...
        <div className="policy-container">
            ...
            <section className="policy-section">
                ...
                <ul className="policy-list">
                    <li><strong>Account Information:</strong> Email address, username, and password (stored using industry-standard encryption).</li>
                    <li><strong>Reading Data:</strong> Books added to lists, reading progress, completed books, ratings, and reviews.</li>
                    <li><strong>User-Generated Content:</strong> Forum posts, comments, mood boards, and profile customizations.</li>
                    <li><strong>Technical Data:</strong> IP address, browser type, device information, and cookies for authentication and session management.</li>
                </ul>
            </section>
            ...
            <section className="policy-section">
                ...
                <ul className="policy-list">
                    <li><strong>Google Books API:</strong> Used solely to search for and display public book information.</li>
                    <li><strong>Pinterest API (Optional):</strong> Used only if you opt in to create and browse mood boards.</li>
                </ul>
                <p className="policy-paragraph">
            ...
            <section className="policy-section">
                ...
                <ul className="policy-list">
                    <li><strong>What's Public:</strong> Your username, public profile, book reviews, forum posts, and mood boards (if marked public) are visible to other users.</li>
                    <li><strong>What's Private:</strong> Your email, password, private reading lists, and lists marked as private are kept confidential.</li>
                    <li><strong>Friend Visibility:</strong> Your reading progress and reviews are visible to your confirmed friends, subject to your current privacy settings.</li>
                </ul>
                <p className="policy-paragraph">
            ...
            <section className="policy-section">
                ...
                <ul className="policy-list">
                    <li><strong>Access & Edit:</strong> You can view, edit, or delete your personal data at any time through your profile settings.</li>
                    <li><strong>Control:</strong> You can control privacy settings for your reading lists and activity.</li>
                    <li><strong>Opt-Out:</strong> You can opt out of email notifications and reminders.</li>
                </ul>
            </section>
            ...
            <section className="policy-section">
                ...
                <p className="policy-paragraph contact-info">
                    If you have any questions or concerns regarding this Privacy Policy, your data, or data requests, please contact us at:
                </p>
                <p className="policy-paragraph contact-info">
                    Email: {contactEmail}
                </p>
                {/* Include faculty advisor info if required by your capstone guidelines */}
                <p className="policy-paragraph contact-info">
                    Academic Advisor Contact: [Faculty Advisor Name, if applicable]
                </p>
            </section>
        </div>
    );
