...
const FriendProfile = () => {
  ...
  useEffect(() => {
    const fetchLists = async () => {
      try {
        ...
        const publicLists = (res.data || []).filter(
          (l) => l.privacy === "public",
        );
  ...
  if (loading) {
    return (
      <div className="profile-page friend-profile-loading">Loading...</div>
    );
  }
  ...
  return (
    <div className="profile-page friend-profile-page">
              ...
              {getDetailBooks().length > 0 ? (
                getDetailBooks().map((book) => (
                  ...
                  >
                    ...
                    >
                      {userBookshelf.includes(book.id)
                        ? "Saved"
                        : "Add to Library"}
                    </button>
                  </div>
