...
import tamaraImg from "../assets/tamaraaboutpicture.jpg";
import tasnimImg from "../assets/tasnimaboutpicture.jpg";
...
const About = () => {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      role: "Full-stack Developer",
      image: tamaraImg,
      link: "https://www.linkedin.com/in/tamara-grujicic-1536b128b/",
    },
    {
      name: "Tasnim Haque",
      role: "Full-stack Developer",
    ...
    <div className="about-container" aria-label="About Next Chapter page">
      ...
      >
        ...
        <div className="mission-text">
          <p>
            In today's fast-paced world, finding time, motivation, and focus for
            reading can feel impossible. Next Chapter was created to change
            that.
          </p>
          <p>
            We strive to make reading engaging, accessible, and
            community-driven. Start your next chapter by building lasting
            habits, discovering new books, and connecting with fellow readers.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="features-grid">
          <div
            ...
            aria-label="Feature: Smart book management"
          >
          ...
          <div
            className="feature-card"
            aria-label="Feature: Community connection"
          >
            <GroupsIcon className="feature-icon" aria-hidden="true" />
            <h3>Community Connection</h3>
            <p>Connect with readers and share your journey.</p>
            <div className="card-line"></div>
          </div>

          <div
            className="feature-card"
            aria-label="Feature: Creative expression"
          >
            <AutoAwesomeIcon className="feature-icon" aria-hidden="true" />
            <h3>Creative Expression</h3>
            <p>Show off your badges and make your profile uniquely yours.</p>
            <div className="card-line"></div>
          </div>

          <div
            className="feature-card"
            aria-label="Feature: Discover new reads"
          >
            <SearchIcon className="feature-icon" aria-hidden="true" />
            <h3>Discover New Reads</h3>
            <p>
              Discover your next literary adventure with personalized
              suggestions.
            </p>
            <div className="card-line"></div>
          </div>
      ...
      >
        ...
        <p className="team-intro">
          Next Chapter was created by a team of five passionate developers and
          book lovers as a Capstone project. United by our shared belief that
          reading should be accessible and enjoyable for everyone, we combined
          our technical skills and creativity to build a platform that addresses
      ...
      {/* Vision Section */}
      <section className="about-section vision-section" aria-label="Our vision">
        <div className="vision-content">
          <RocketLaunchIcon className="vision-icon" aria-hidden="true" />
          <h2 className="section-heading">Our Vision</h2>
          <p>
            We envision a world where reading is celebrated as both a personal
            journey and a shared experience. Through Next Chapter, we're
            building more than just an app—we're cultivating a global community
            of readers who inspire each other, share recommendations, and
            rediscover the joy of getting lost in a good book.
          </p>
        </div>
      </section>
      ...
      <section className="about-cta" aria-label="Call to action">
        ...
        <p>
          Join our community of readers and transform the way you experience
          books.
        </p>
